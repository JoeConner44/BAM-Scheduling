...
import { PrismaClient, type EquipmentType, type Prisma, type ProjectStatus, type Priority, type WeatherSensitivity } from "@prisma/client";
...
async function main() {
  ...
  console.log(`Seeded sample data. Today = ${T}; D0 = ${workdayOffset(T, 0)}.`);
}
